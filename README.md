...
4. **Календарь ресурсов** Синхронизированный график сменности с долгосрочным планированием. Автоматический расчет графика в обе стороны.
...
> **При просмотре с телефона:** приложение GitHub на Android не отображает диаграммы — показывается исходный код. Чтобы увидеть графики, откройте репозиторий в **браузере** (Chrome и т.п.) на телефоне или на ПК.
...
```mermaid
gantt
    title Стратегический план развития VK-Book Android
    dateFormat  YYYY-MM-DD
    section Production
    Production Ready v1.0 :done, 2024-01-01, 2025-02-01
    section Развитие
    Масштабирование на новые объекты :active, 2025-03-01, 2026-06-30
    Расширение функционала : 2025-09-01, 2026-12-31
```
...
| Арматура (поиск) | Арматура (список) | График проверок |
|------------------|-------------------|------------------|
| ![Арматура](docs/screenshots/01-armature.png) | ![Арматура список](docs/screenshots/02-armature-list.png) | ![График проверок](docs/screenshots/03-inspection-schedule.png) |

| Просмотр схемы | График смен |
|----------------|-------------|
| ![Схемы](docs/screenshots/04-scheme-view.png) | ![График смен](docs/screenshots/05-shift-graph.png) |
...
4. **Расписание** — Календарь смен с долгосрочным планированием
